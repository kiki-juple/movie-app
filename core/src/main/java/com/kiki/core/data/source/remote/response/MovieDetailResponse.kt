...
data class MovieDetailResponse(
    ...
    @SerializedName("production_companies") var productionCompanies: List<ProductionCompanies> = emptyList(),
    @SerializedName("production_countries") var productionCountries: List<ProductionCountries> = emptyList(),
    @SerializedName("release_date") var releaseDate: String? = null,
    @SerializedName("revenue") var revenue: Int? = null,
    @SerializedName("runtime") var runtime: Int? = null,
    @SerializedName("spoken_languages") var spokenLanguages: List<SpokenLanguages> = emptyList(),
